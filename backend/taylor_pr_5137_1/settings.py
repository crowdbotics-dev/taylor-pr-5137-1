"""
Django settings for taylor_pr_5137_1 project.
...
ROOT_URLCONF = 'taylor_pr_5137_1.urls'
...
WSGI_APPLICATION = 'taylor_pr_5137_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taylor_pr_5137_1 API",
    "DESCRIPTION": "API documentation for taylor_pr_5137_1 App",
    "VERSION": "v1",
}
